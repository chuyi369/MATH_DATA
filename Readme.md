...
### 1. ChatCoT: Tool-Augmented Chain-of-Thought Reasoning on Chat-based Large Language Models（Zhipeng Chen, Kun Zhou, Beichen Zhang, Zheng Gong, Wayne Xin Zhao, Ji-Rong Wen）
...
### 2.Boosted Prompt Ensembles for Large Language Models（Silviu Pitis, Michael R. Zhang, Andrew Wang, Jimmy Ba）

### paper：https://arxiv.org/abs/2304.05970

### dataset：MATH，GSM8K，AQuA，HotPotQA，QASC



### 3.Deductive Verification of Chain-of-Thought Reasoning（Zhan Ling, Yunhao Fang, Xuanlin Li, Zhiao Huang, Mingu Lee, Roland Memisevic, Hao Su）
...
### 4.CREATOR: Disentangling Abstract and Concrete Reasonings of Large Language Models through Tool Creation（Cheng Qian, Chi Han, Yi R. Fung, Yujia Qin, Zhiyuan Liu, Heng Ji）
...
### 5.Learning Multi-Step Reasoning by Solving Arithmetic Tasks（Tianduo Wang, Wei Lu）

### paper：https://arxiv.org/abs/2306.01707

### dataset：MATH，Physics，新建数据库Arithmetic



### 6.Solving Probability and Statistics Problems by Program Synthesis（Xinyun Chen∗ , Chang Liu∗ , Dawn Song∗ , Tianqi Chen† ∗University of California Berkeley †University of Washington Seattle）

### paper：https://arxiv.org/pdf/2306.01707.pdf

### dataset：MATH，Physics
...
### 5.Solving machine learning problems(Sunny Tran, Pranav Krishna, Ishan Pakuwal, Prabhakar Kafle, Nikhil Singh, Jayson Lynch, Iddo Drori)

### paper：https://arxiv.org/abs/2107.01238



### 6.Plan-and-Solve Prompting: Improving Zero-Shot Chain-of-Thought Reasoning by Large Language Models(Lei Wang, Wanyu Xu, Yihuai Lan, Zhiqiang Hu, Yunshi Lan, Roy Ka-Wei Lee, Ee-Peng Lim)
...
### 7.FinMath: Injecting a Tree-structured Solver for Question Answering over Financial Reports(Chenying Li† , Wenbo Ye‡ , Yilun Zhao∗ †Northeastern University ‡Zhejiang University ∗Yale University )
### paper：https://aclanthology.org/2022.lrec-1.661.pdf



### 8.Solving Math Word Problems by Combining Language Models With Symbolic Solvers(Xiaodong Shi∗ , Qing Li∗ , Weiwei Sun∗ , Xiaojun Wan∗ ∗Peking University Beijing ChinaPrabhakar Kafle, Nikhil Singh, Jayson Lynch, Iddo Drori)

### paper：https://github.com/AGI-

### dataset：MATH，MAWPS，GSM8K，DRAW-1K
...
### 4.An Empirical Study on Challenging Math Problem Solving with GPT-4(Yiran Wu, Feiran Jia, Shaokun Zhang, Hangyu Li, Erkang Zhu, Yue Wang, Yin Tat Lee, Richard Peng, Qingyun Wu, Chi Wang)
...
### 5.RECEVAL: Evaluating Reasoning Chains via Correctness and Informativeness（Archiki Prasad, Swarnadeep Saha, Xiang Zhou, Mohit Bansal ）
### paper：https://arxiv.org/abs/2304.10703

### dataset：MATH，Entailment Bank，HotPotQA



### 6.Cost-Effective Hyperparameter Optimization for Large Language Model Generation Inference（Chi Wang, Susan Xueqing Liu, Ahmed H. Awadallah）
...
### 7.The Wisdom of Hindsight Makes Language Models Better Instruction Followers（Tianjun Zhang, Fangchen Liu, Justin Wong, Pieter Abbeel, Joseph E. Gonzalez）
### paper：https://arxiv.org/abs/2302.05206

### dataset：MATH， MathQA， SCAN，CFQ
